    ...
    return (
        <div>
            <div className="md:flex justify-between pb-10 px-5 mt-20">
                <h1 className=' flex justify-center pb-4 md:pb-0 md:text-3xl text-xl font-semibold text-cyan-500'> Shop Healthcare Categories </h1>
                    ...
                    ShopData.map(data =>
                        <>
                            <Link to="/item-details">
                                <div key={data.id} onClick={() => handleCardClick(data)} className="p-3 hover:shadow-2xl cursor-pointer w-full h-full hover:bg-slate-50 transform group ">
